# -*- coding: utf-8 -*-
"""EWC ASR_2batches.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gkfyQ1kHkmdxinIoeQsW0ikqOaV8tIwW

EWC with 2 class split: Dataset A (15 classes) and Dataset B (20 classes)
"""
...
for e in range(N_EPOCHS):
  ...
  for i, batch in enumerate(tqdm_notebook(train_dl)):
    ...
    ewc_loss = 0
    for n,p in new_net.speech_model.named_parameters():
      if p.requires_grad:
        l = prec[n[:]]*(p-mat[n[:]])**2
        ewc_loss +=l.sum()
    
    # Compute the loss
    loss = criterion(y, labels) + lamda*ewc_loss
  ...
  print("Training accuracy:", running_accuracy/float(len(train_set)),
        "Training loss:", running_loss/float(len(train_set)), "EWC Loss:", ewc_loss)

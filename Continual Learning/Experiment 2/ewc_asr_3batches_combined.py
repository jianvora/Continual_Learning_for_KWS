# -*- coding: utf-8 -*-
"""EWC ASR_3batches_combined.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1hwVBn4vWKrP-mn6XvAofUQSZ781cOPuO
"""
...
train_setA = SpeechDataset(classes_A, training_listA, classes_BC, training_listBC)
val_setA =SpeechDataset(classes_A, testing_listA, classes_BC, testing_listBC)
...
test_datasetA = SpeechDataset(classes_A, testing_listA, classes_BC, testing_listBC)
...
train_setB = SpeechDataset(classes_B, training_listB, classes_AC, training_listAC)
val_setB =SpeechDataset(classes_B, testing_listB, classes_AC, testing_listAC)
...
LEARNING_RATE = 0.0005
elambda = 20 #ewc lambda in loss function
...
for e in range(N_EPOCHS):
  ...
  for i, batch in enumerate(tqdm_notebook(train_dlB)):
    ...
    # Compute the loss
    loss = criterion(y, labels) + elambda*ewc_loss
  ...
  print("Training accuracy:", running_accuracy/float(len(train_setB)),
        "Training loss:", running_loss/float(len(train_setB)), "EWC Loss:", ewc_loss)
...
# Create a test dataset instance
test_datasetB = SpeechDataset(classes_B, testing_listB, classes_AC, testing_listAC)
...
train_setC = SpeechDataset(classes_C, training_listC, classes_AB, training_listAB)
val_setC =SpeechDataset(classes_C, testing_listC, classes_AB, training_listAB)
...
for e in range(N_EPOCHS):
  ...
  print("Training accuracy:", running_accuracy/float(len(train_setC)),
        "Training loss:", running_loss/float(len(train_setC)), "EWC Loss:", ewc_loss)
...
# Create a test dataset instance
test_datasetC = SpeechDataset(classes_C, testing_listC, classes_AB, testing_listAB)

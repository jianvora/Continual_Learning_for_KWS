# -*- coding: utf-8 -*-
"""CRA_ASR_3batches_combined.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1orRUkHEEhx4Xz0XLZXX2OWLN5OzsBanl
"""
...
LEARNING_RATE = 0.0005
elambda = 1 #ewc lambda in loss function
...
for e in range(N_EPOCHS):
  ...
  for i, batch in enumerate(tqdm_notebook(train_dlB)):
    ...
    # Compute the loss
    loss = criterion(y, labels) + elambda*cra_loss
...
for e in range(N_EPOCHS):
  ...
  for i, batch in enumerate(tqdm_notebook(train_dlC)):
    ...
    cra_loss = 0
    cra_loss = cra(netB.speech_model, netC.speech_model,old_batch[0], old_labels[1])
